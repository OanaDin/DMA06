...
//                    int receivedBitmapCode = 1122;
    ...
    //această metodă este concepută pentru a obține date JSON de la un server
    // prin intermediul unei conexiuni HTTP, a parsa aceste date în obiecte Recipe,
    // și a le adăuga la o listă existentă de rețete (recipes).
    // Apoi, aceasta afișează informații despre rețetele actualizate în consolă.
    ...
    //această metodă este concepută pentru a trimite date JSON către un server
    // prin intermediul unei conexiuni HTTP, pentru a obține o valoare de răspuns de la server
    // și pentru a afișa această valoare în consolă.
    // Este posibil ca valoarea să conțină informații
    // sau confirmări legate de procesul de trimitere a datelor către server.
